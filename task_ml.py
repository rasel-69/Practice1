...
### (7)-- ------ Hyper parameter Tuning of Decision Tree using GridSearchCV for max_depth of decision Tree classifier while Other parameters was constant Start here ------#
...
# Parameter grid for only max_depth
parameter_grid = {
    'max_depth': [5, 10, 15, 20, 25, 30]  # None means unlimited depth
}
...
#####  -------------------- Hyper parameter Tuned Decision Tree Ends Here ---------------------- ########
